...
# В его конструкторе инициализировать параметр, соответствующий количеству клеток (целое число). В классе должны быть
...
class Cell:
    ...
    def __sub__(self, other):
        if self.num_units >= other.num_units:
            ...
            return Cell(other.num_units - self.num_units)
    ...
    def make_order(self, in_row):
        row = str()
        i = round(self.num_units / in_row)
        z = str('*' * in_row)
        z_ost = str('*' * (self.num_units % in_row))
        for a in range(i):
            row += f"{z} \n"
        row += f'{z_ost}'
        return row
...
print("Сложение:", (cell_1 + cell_2 + cell_3))
print("Вычитание:", (cell_1 - cell_2 - cell_3))
print("Умножение:", (cell_1 * cell_2 * cell_3))
print("Деление:", (cell_1 // cell_2 // cell_3))
print((cell_1 + cell_2 + cell_3).make_order(5))
